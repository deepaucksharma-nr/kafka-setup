...
# Collection modes
COLLECT_CONSUMER_GROUPS = os.environ.get('COLLECT_CONSUMER_GROUPS', 'true').lower() == 'true'
COLLECT_SHARE_GROUPS = os.environ.get('COLLECT_SHARE_GROUPS', 'true').lower() == 'true'
COLLECT_PRODUCERS = os.environ.get('COLLECT_PRODUCERS', 'true').lower() == 'true'
COLLECT_BROKER_HEALTH = os.environ.get('COLLECT_BROKER_HEALTH', 'true').lower() == 'true'

# Entity configuration
CLUSTER_NAME = os.environ.get('CLUSTER_NAME', 'kafka-k8s-cluster')
ENVIRONMENT = os.environ.get('ENVIRONMENT', 'production')
REGION = os.environ.get('REGION', 'us-east-1')
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'kafka-monitoring')
CLOUD_PROVIDER = os.environ.get('CLOUD_PROVIDER', 'self-hosted')
